...
class DemographicsService:
    ...
    def _load_demographics(self):
        ...
        try:
            ...
            self._demographics_df['zipcode'] = self._demographics_df['zipcode'].astype(str)
    ...
    def get_demographics(self, zipcode: str) -> Dict:
        ...
        return {
            ...
            'median_income': float(row.get('median_income', self._get_median('median_income'))),
            'population_density': float(row.get('population_density', self._get_median('population_density'))),
